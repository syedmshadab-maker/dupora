...
void main() {
  ...
  test(
    'storePartial then storeFull upgrades the same row rather than duplicating',
    () async {
      final file = _file('a');
  ...
  test(
    'incremental rescan simulation: unchanged files stay cached, changed files do not',
    () async {
